...
#include "tutorial_interfaces/msg/detail/pose_stamped__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tutorial_interfaces::msg::PoseStamped;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const tutorial_interfaces::msg::PoseStamped *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tutorial_interfaces::msg::PoseStamped *>(
    untyped_ros_message);
...
{
  return &tutorial_interfaces::msg::typesupport_fastrtps_cpp::_PoseStamped__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tutorial_interfaces, msg, PoseStamped)() {
  return &tutorial_interfaces::msg::typesupport_fastrtps_cpp::_PoseStamped__handle;
}
