...
#ifndef TUTORIAL_INTERFACES__MSG__DETAIL__POSE_STAMPED__TRAITS_HPP_
#define TUTORIAL_INTERFACES__MSG__DETAIL__POSE_STAMPED__TRAITS_HPP_
...
inline void to_yaml(
  const tutorial_interfaces::msg::PoseStamped & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const tutorial_interfaces::msg::PoseStamped & msg)
{
  return tutorial_interfaces::msg::to_yaml(msg);
}

template<>
inline const char * data_type<tutorial_interfaces::msg::PoseStamped>()
{
  return "tutorial_interfaces::msg::PoseStamped";
}

template<>
inline const char * name<tutorial_interfaces::msg::PoseStamped>()
{
  return "tutorial_interfaces/msg/PoseStamped";
}
...
#endif  // TUTORIAL_INTERFACES__MSG__DETAIL__POSE_STAMPED__TRAITS_HPP_
