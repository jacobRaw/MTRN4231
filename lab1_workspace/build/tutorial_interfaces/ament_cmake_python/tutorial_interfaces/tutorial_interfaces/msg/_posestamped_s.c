...
bool tutorial_interfaces__msg__posestamped__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
...
PyObject * tutorial_interfaces__msg__posestamped__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("tutorial_interfaces.msg._posestamped");
