...
bool tutorial_interfaces__msg__pose_stamped__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tutorial_interfaces.msg._pose_stamped.PoseStamped", full_classname_dest, 49) == 0);
  }
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * tutorial_interfaces__msg__pose_stamped__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of PoseStamped */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("tutorial_interfaces.msg._pose_stamped");
