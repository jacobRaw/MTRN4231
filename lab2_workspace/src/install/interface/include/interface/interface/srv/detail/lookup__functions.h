...
#ifndef INTERFACE__SRV__DETAIL__LOOKUP__FUNCTIONS_H_
#define INTERFACE__SRV__DETAIL__LOOKUP__FUNCTIONS_H_
 ...
 * calls
 * interface__srv__Lookup_Request__init().
...
/**
 * It calls
 * interface__srv__Lookup_Request__fini()
 ...
 * interface__srv__Lookup_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * interface__srv__Lookup_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * interface__srv__Lookup_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_interface
...
/**
 * It calls
 * interface__srv__Lookup_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_interface
...
/**
 * It allocates the memory for the array and calls
 * interface__srv__Lookup_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_interface
...
/**
 * It calls
 * interface__srv__Lookup_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // INTERFACE__SRV__DETAIL__LOOKUP__FUNCTIONS_H_
