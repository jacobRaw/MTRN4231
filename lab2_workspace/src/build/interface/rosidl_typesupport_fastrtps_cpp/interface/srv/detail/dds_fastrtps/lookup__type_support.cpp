...
#include "interface/srv/detail/lookup__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interface::srv::Lookup_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interface::srv::Lookup_Request & ros_message)
{
  // Member: toframe
  cdr >> ros_message.toframe;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interface::srv::Lookup_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interface::srv::Lookup_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interface::srv::Lookup_Request *>(
    untyped_ros_message);
...
{
  return &interface::srv::typesupport_fastrtps_cpp::_Lookup_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interface, srv, Lookup_Request)() {
  return &interface::srv::typesupport_fastrtps_cpp::_Lookup_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_interface
cdr_serialize(
  const interface::srv::Lookup_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: pose
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interface::srv::Lookup_Response & ros_message)
{
  // Member: pose
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = interface::srv::Lookup_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interface::srv::Lookup_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<interface::srv::Lookup_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &interface::srv::typesupport_fastrtps_cpp::_Lookup_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interface, srv, Lookup_Response)() {
  return &interface::srv::typesupport_fastrtps_cpp::_Lookup_Response__handle;
}
...
{
  return &interface::srv::typesupport_fastrtps_cpp::_Lookup__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interface, srv, Lookup)() {
  return &interface::srv::typesupport_fastrtps_cpp::_Lookup__handle;
}
